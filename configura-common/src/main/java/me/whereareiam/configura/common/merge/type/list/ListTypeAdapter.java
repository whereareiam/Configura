...
/**
 * Built-in adapter for {@link List} fields only.
 */
public final class ListTypeAdapter implements MergeTypeAdapter {
	@Override
	...
	public @NotNull Class<?> resolveChildType(@NotNull MergeTypeDescriptor descriptor, @NotNull MergePolicy policy) {
		...
		Class<?> resolved = descriptor.resolveGenericArgument(0);
